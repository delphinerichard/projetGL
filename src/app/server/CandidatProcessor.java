...
import app.businessObject.CandidatDAOImpl_serveur;
import app.message.*;
...
public class CandidatProcessor implements Runnable{
    ...
    public CandidatProcessor(Socket pSock, Statement sqlStmt){
        this.sock = pSock;
    ...
    public void run(){
        ...
        while(!sock.isClosed()) try {
            ...
            if(response instanceof ClientAuth){
                ...
                CandidatMessageVersClient session = findSession((CandidatMessageVersServeur) response);
    ...
    public CandidatMessageVersClient findSession(CandidatMessageVersServeur auth) throws SQLException {
        Candidat candidat = new CandidatDAOImpl_serveur(sqlStmt).getCandidat(auth.getId());
        CandidatMessageVersClient session = new CandidatMessageVersClient(candidat, null);
        return session;
    }
